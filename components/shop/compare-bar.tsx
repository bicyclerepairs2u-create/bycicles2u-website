        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 overflow-x-auto">
            <div className="flex items-center gap-2 shrink-0">
              <Scale className="w-5 h-5 text-[#ff1744]" />
              ...
              {compareItems.map((product) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-0.5 text-[var(--theme-text-muted)] hover:text-[#ff1744] transition-colors"
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#ff1744] text-black font-bold text-sm uppercase tracking-wider transition-all hover:bg-[#d50032] disabled:opacity-50 disabled:cursor-not-allowed shrink-0"
          >
